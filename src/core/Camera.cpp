...
GLboolean CLOSE[] = {true, true, true, true};
...
void Refresh(HWND hWnd)
{
    ...
    //glFrustum( - 0.05 * width / 800.0f , 0.05 * width / 800.0f, - 0.0375 * height / 600.0f, 0.0375 * height / 600.0f , 0.1, 1500.0 );
...
void MapCreate() // 0 pusto, 1 drzwi, 2 sciana
{
    ///////////////////////////////////////////
...
inline bool TestMap(float x, float z, bool door)
{
